...
kubectl set image deployments/client-deployment server=hrmtsngh18/multi-client:$SHA
kubectl set image deployments/worker-deployment server=hrmtsngh18/multi-worker:$SHA